...
class ScenarioResult(BaseModel):
    ...
    clean_price: float
    pv_of_stepup: float
    certain_clean_price: Optional[float] = None
    spread_value_bps: Optional[float] = None
    yield_value_bps: Optional[float] = None
...
class BondPriceResponse(BaseModel):
    ...
    has_principal_pct_steps: bool = False
    price_to_call: Optional[float] = None
    clean_price_to_call: Optional[float] = None
    step_up_spread_bps: Optional[float] = None
    step_up_yield_bps: Optional[float] = None
